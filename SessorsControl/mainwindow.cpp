...
//    OpenCo2Com();//打开co2传感器串口
 ...
 //   InitRos();//初始化节点
    ...
    connect(g_RosTopic,&RosControl::StartRead,this,&MainWindow::StartReadSessor);
...
void MainWindow::StartReadSessor(const std_msgs::String::ConstPtr& msg)
{
     qDebug("I heard: [%s]", msg->data.c_str());
}
